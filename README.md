...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-30 16:35`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e745fc6b-907d-4b5a-9a5a-f70ca1f4fdaa.git
$ cd e745fc6b-907d-4b5a-9a5a-f70ca1f4fdaa
```
